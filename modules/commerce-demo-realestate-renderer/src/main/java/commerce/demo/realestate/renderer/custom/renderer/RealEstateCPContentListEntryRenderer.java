...
@Component(
		immediate = true,
		property = {
				"commerce.product.content.list.entry.renderer.key=" + RealEstateCPContentListEntryRenderer.KEY,
...
public class RealEstateCPContentListEntryRenderer implements CPContentListEntryRenderer {

	public static final String KEY = "realestate-catalog";
	...
	@Reference(
			target = "(osgi.web.symbolicname=commerce.demo.realestate.renderer)"
		)
