...
@Component(immediate = true, property = {
	"commerce.product.content.renderer.key=" + TabsRealEstateCPContentRenderer.KEY,
    "commerce.product.content.renderer.order=" + 1,
	"commerce.product.content.renderer.type=simple",
}, service = CPContentRenderer.class)
public class TabsRealEstateCPContentRenderer implements CPContentRenderer {

	public static final String KEY = "tabs-real-estate";
	...
	public String getLabel(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "tabs-real-estate");
	}
	...
	public void render(
		...
		_jspRenderer.renderJSP(
			...
			"/render/view-tabs.jsp");

	}

	private static final Log _log =
		LogFactoryUtil.getLog(TabsRealEstateCPContentRenderer.class);
