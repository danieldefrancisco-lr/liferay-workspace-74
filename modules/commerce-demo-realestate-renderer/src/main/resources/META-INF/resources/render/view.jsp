...
.localidad-provincia a.head-map {
    background: url(./images/placeholder.svg) no-repeat;
    padding-left: 20px;
    font-weight: bold;
    display: inline-block;
}
.features-list-fav ul.features-list {
    margin: 0;
    padding: 2px 0 0;
    display: inline-block;
...
.features-list-fav ul.features-list li.features-list-metros {
    background: url(./images/metros.svg) no-repeat left center;
		...
		<div class="commerce-component-header product-detail-header">
			...
			<div class="features-list-fav">
				<ul class="features-list">
					<li class="features-list-metros">109m<sup>2</sup></li>
				</ul>
			</div>
		</div>
...
<div class="product-detail-description">
	<div class="container-fluid container-fluid-max-xl">
		...
		<div class="tab-content">
			<c:if test="<%= cpContentHelper.hasCPDefinitionSpecificationOptionValues(cpDefinitionId) %>">
				<div class="active fade show tab-pane" id="<portlet:namespace />specifications">
